...
// base price, combat, monster, walk,ride,fly,swim
    ...
    {"boots of levitation","boots of levitation","BOOT",0,
     -1,0,-1,0,0,IT_MAGIC,
     1000,0,0,0,0,0,15},
    {"trifle", "trifles", "TRIF", 0,
     -1,0,-1,0,1,IT_SPECIAL,
     10000,0,0,0,0,0,0},
    // Tails: Catapult
    {"catapult","catapults","CATA",0,
     S_WEAPONSMITH,6,I_IRONWOOD,40,2000,IT_ADVANCED | IT_WEAPON,
     200,1,WEAPON_CATAPULT,0,0,0,0}
};
...
static SkillType sd[] = {
    ...
    // Tails: new skill for Catapulta
    {"ballistics","BALL",10, SkillType::FOUNDATION,
     0, S_CROSSBOW,1,S_LONGBOW,1,-1,0}
};
...
static ObjectType ot[] =
{
    ...
    {"Grave",0,0,I_STONE,2,1,S_BUILDING,0,1,-1,-1},
    {"Graveyard",0,0,I_STONE,50,1,S_BUILDING,0,1,-1,-1},
    {"Statue",0,0,I_STONE,5,1,S_BUILDING,0,1,-1,-1},
    {"Monument",0,0,I_STONE,5,1,S_BUILDING,0,1,-1,-1},
    {"Temple",0,0,I_STONE,30,1,S_BUILDING,0,1,-1,-1},
    {"Obelisk",0,0,I_STONE,15,1,S_BUILDING,0,1,-1,-1},
    {"Root Road N" ,0,0,I_ROOTSTONE,50,5,S_BUILDING,0,1,-1,-1},
    {"Root Road NW",0,0,I_ROOTSTONE,50,5,S_BUILDING,0,1,-1,-1},
    {"Root Road NE",0,0,I_ROOTSTONE,50,5,S_BUILDING,0,1,-1,-1},
    {"Root Road SW",0,0,I_ROOTSTONE,50,5,S_BUILDING,0,1,-1,-1},
    {"Root Road SE",0,0,I_ROOTSTONE,50,5,S_BUILDING,0,1,-1,-1},
    {"Root Road S" ,0,0,I_ROOTSTONE,50,5,S_BUILDING,0,1,-1,-1},
};
