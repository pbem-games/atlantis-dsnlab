...
public:
    ...
    // Dwelller - added one more parameter (pointer to Battle) for report writong
    //int DoAnAttack( int special, int numAttacks, int attackType,
    //                int attackLevel, int flags, int effect );
	// Tails: added Catapult
	//int DoAnAttack( int special, int numAttacks, int attackType,
    //                int attackLevel, int flags, int effect, Battle* b = 0, int weap = 0 );

    int DoAnAttack( int special, int numAttacks, int attackType,
                    int attackLevel, int flags, int effect, Battle* b = 0, int weap = 0 );
    void WriteRemainedFSHIStatistic( Battle* b );
    // end of Dweller
    void Kill(int);
    void Reset();
