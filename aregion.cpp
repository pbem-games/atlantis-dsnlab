...
void ARegion::DoDecayCheck()
{
    ...
    {
        Object *o = (Object *) elem;
        if (o->IsRoadUsable()&&(!o->IsRootRoad()))
        {
            DoDecayClicks(o);
        }
    }
...
int ARegion::HasExitRoad(int realDirection)
{
    forlist (&objects)
    {
        ...
        if (o->IsRoadUsable())
        {
            ...
            if (o->type == GetRootRoadDirection(realDirection)) return 1;
        }
    }
    return 0;
}
...
int ARegion::GetRootRoadDirection(int realDirection)
{
  int roadDirection = 0;
  switch (realDirection)
  {
    case D_NORTH:
      roadDirection = O_ROOT_ROADN;
      break;
    case D_NORTHEAST:
      roadDirection = O_ROOT_ROADNE;
      break;
    case D_NORTHWEST:
      roadDirection = O_ROOT_ROADNW;
      break;
    case D_SOUTH:
      roadDirection = O_ROOT_ROADS;
      break;
    case D_SOUTHEAST:
      roadDirection = O_ROOT_ROADSE;
      break;
    case D_SOUTHWEST:
      roadDirection = O_ROOT_ROADSW;
      break;
  }
  return roadDirection;
}
